...
const DownloadData = () => {
  ...
  const handleDownload = async (e) => {
    ...
    if (allTime) {
      // Download all data
      try {
        const response = await axios.get('/api/download?type=employee&all=true').then(data => data)
      ...
      try {
        ...
        const response = await axios.get(`/api/download?type=employee&start=${start}&end=${end}`).then(data => data)
        console.log(response)
        setData(response.data)
